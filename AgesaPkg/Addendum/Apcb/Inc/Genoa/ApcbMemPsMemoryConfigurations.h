...
#define CHANNEL_I      0x01    ///<  Apply to Channel I, 0x100 >> 8, shift right one byte to convert word data to byte
#define CHANNEL_J      0x02    ///<  Apply to Channel J  0x200 >> 8
#define CHANNEL_K      0x04    ///<  Apply to Channel K  0x400 >> 8
#define CHANNEL_L      0x08    ///<  Apply to Channel L  0x800 >> 8
///
/// DIMM MASKS
...
#define NUMBER_OF_DIMMS_SUPPORTED_12_CHANNEL(SocketID, ChannelID_low, ChannelID_high, NumberOfDimmSlotsPerChannel) \
  PSO_MAX_DIMMS, 6, SocketID, ChannelID_low, ChannelID_high, ALL_DIMMS, NumberOfDimmSlotsPerChannel, 0

#define BLDCFG_NUM_DIMMS_SUPPORTED_12_CHANNEL_1(SocketID, ChannelID_low, ChannelID_high, NumberOfDimmSlotsPerChannel) \
  PSO_MAX_DIMMS, 6, SocketID, ChannelID_low, ChannelID_high, ALL_DIMMS, NumberOfDimmSlotsPerChannel, 0
...
#define NUMBER_OF_DIMMS_SUPPORTED_SIZE  8
