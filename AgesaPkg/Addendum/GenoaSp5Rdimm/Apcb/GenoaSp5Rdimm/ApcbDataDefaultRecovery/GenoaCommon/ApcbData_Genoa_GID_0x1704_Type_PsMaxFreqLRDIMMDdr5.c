...
/**
 * @file ApcbData_Genoa_GID_0x1704_Type_PsMaxFreqLRDIMMDdr5.c
 *
 * @brief Max Frequency for DDR5 LRDIMM declaration in AGESA PSP Customization Block.
 *
 */
...
APCB_V3_TYPE_HEADER       ApcbTypeHeader = {
  ...
  APCB_MEM_TYPE_PS_LRDIMM_DDR5_MAX_FREQ,      // TypeId
...
PSCFG_MAXFREQ_ENTRY MaxFeqLRDIMMDdr5 [] = {
  ...
  { _2DIMM,         1,      0,    1,    0,   DDR5200_FREQUENCY, UNSUPPORTED_DDR_FREQUENCY, UNSUPPORTED_DDR_FREQUENCY },
