...
// Helper Marco
//
#define  SOCKET_0     0x00  ///< Socket 0
#define  SOCKET_1     0x01  ///< Socket 1
#define  DIMM_SLOT_A  0x00  ///< DIMM slot label on board, slot A
#define  DIMM_SLOT_B  0x01  ///< DIMM slot label on board, slot B
#define  DIMM_SLOT_C  0x02  ///< DIMM slot label on board, slot C
#define  DIMM_SLOT_D  0x03  ///< DIMM slot label on board, slot D
#define  DIMM_SLOT_E  0x04  ///< DIMM slot label on board, slot E
#define  DIMM_SLOT_F  0x05  ///< DIMM slot label on board, slot F
#define  DIMM_SLOT_G  0x06  ///< DIMM slot label on board, slot G
#define  DIMM_SLOT_H  0x07  ///< DIMM slot label on board, slot H
#define  DIMM_SLOT_I  0x08  ///< DIMM slot label on board, slot I
#define  DIMM_SLOT_J  0x09  ///< DIMM slot label on board, slot J
#define  DIMM_SLOT_K  0x0A  ///< DIMM slot label on board, slot K
#define  DIMM_SLOT_L  0x0B  ///< DIMM slot label on board, slot L
#define  DIMM_0       0x00  ///< DIMM slot 0
#define  DIMM_1       0x01  ///< DIMM slot 1
#define  I2C_0        0x00  ///< SoC I2C controller 0
#define  I2C_1        0x01  ///< SoC I2C controller 1
#define  I2C_2        0x02  ///< SoC I2C controller 2
#define  I2C_3        0x03  ///< SoC I2C controller 3
...
/**
 *  @brief      Sub-Macro for MAKE_DIMM_ADDR_I2C
 *  @details    Refer to MAKE_DIMM_ADDR_I2C for the definition of param
 */
...
/**
 *  @brief      Sub-Macro for I2C device topology
 *  @param[in]  Key      Compose Socket:Channel:Dimm in MAKE_DIMM_ADDR_I2C into one field
 *  @param[in]  BusID    BusID in the MAKE_DIMM_ADDR_I2C
 *  @param[in]  DevID    DevID in the MAKE_DIMM_ADDR_I2C
 */
typedef struct {
...
MAKE_DIMM_ADDR_I2C (SOCKET_1, DIMM_SLOT_A, DIMM_0, I2C_0, 0xA0)
MAKE_DIMM_ADDR_I2C (SOCKET_1, DIMM_SLOT_B, DIMM_0, I2C_0, 0xA2)
MAKE_DIMM_ADDR_I2C (SOCKET_1, DIMM_SLOT_C, DIMM_0, I2C_0, 0xA4)
MAKE_DIMM_ADDR_I2C (SOCKET_1, DIMM_SLOT_D, DIMM_0, I2C_0, 0xA6)
MAKE_DIMM_ADDR_I2C (SOCKET_1, DIMM_SLOT_E, DIMM_0, I2C_0, 0xA8)
MAKE_DIMM_ADDR_I2C (SOCKET_1, DIMM_SLOT_F, DIMM_0, I2C_0, 0xAA)
MAKE_DIMM_ADDR_I2C (SOCKET_1, DIMM_SLOT_G, DIMM_0, I2C_1, 0xA0)
MAKE_DIMM_ADDR_I2C (SOCKET_1, DIMM_SLOT_H, DIMM_0, I2C_1, 0xA2)
MAKE_DIMM_ADDR_I2C (SOCKET_1, DIMM_SLOT_I, DIMM_0, I2C_1, 0xA4)
MAKE_DIMM_ADDR_I2C (SOCKET_1, DIMM_SLOT_J, DIMM_0, I2C_1, 0xA6)
MAKE_DIMM_ADDR_I2C (SOCKET_1, DIMM_SLOT_K, DIMM_0, I2C_1, 0xA8)
MAKE_DIMM_ADDR_I2C (SOCKET_1, DIMM_SLOT_L, DIMM_0, I2C_1, 0xAA)
