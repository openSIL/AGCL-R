 ...
 */
#ifndef _AMD_MEMORY_INFO_HOB_GENOA_H_
#define _AMD_MEMORY_INFO_HOB_GENOA_H_
...
/**
 * @brief 128 bit Buffer containing UID Unique Identifier value for Memory Config Info HOB.
 * EFI_GUID defined in UefiBaseType.h
 */
...
#define GET_HOB_DIMM_PRESENCE_OF(HobStart, DimmPresentMap, Socket, Die, Channel, Dimm) \
       (UINT8) ((DimmPresentMap##[Socket * ((AMD_MEM_CFG_INFO_HOB_GENOA *)HobStart)->MaxDiePerSocket +\
                      Die] >> (Channel * ((AMD_MEM_CFG_INFO_HOB_GENOA *)HobStart)->MaxDimmPerChannel + Dimm)) & 1)
...
#define GET_MEM_CFG_INFO_HOB_ADDR(HobStart, Offset) \
       (VOID *) ((UINT8 *)HobStart + (UINT16) ((AMD_MEM_CFG_INFO_HOB_GENOA *)HobStart)->Offset)
 ...
 */
typedef struct _AMD_MEM_CFG_INFO_HOB_GENOA {
  /// Version
  ...
  MEM_CFG_INFO_HOB MbistPerBitSecondaryDieReport;   ///< MbistPerBitSecondaryDieReport
...
#endif // _AMD_MEMORY_INFO_HOB_GENOA_H_
