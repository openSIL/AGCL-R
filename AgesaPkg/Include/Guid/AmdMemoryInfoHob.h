...
/**
 * @brief  List of Status constants used in the Memory Info HOB
...
typedef struct _AMD_MEM_CFG_INFO_HOB {
  ...
  MEM_CFG_INFO_HOB MbistPerBitSecondaryDieReport;   ///< MbistPerBitSecondaryDieReport (APCB_TOKEN_CONFIG_MEM_MBIST_PER_BIT_SECONDARY_DIE_REPORT)
